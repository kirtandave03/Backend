...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        const decodedrefeshToken = jwt.verify(incomingRefreshToken, process.env.REFRESH_TOKEN_SECRET);
...
module.exports = { registerUser, loginUser, logoutUser, refreshAccessToken, forgotPassword, getCurrectUser, updateAccountDetails, updateUserAvatar, updateUserCoverImage };